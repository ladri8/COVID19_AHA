...
dft1 <- ef2 %>% dplyr::select(CASE_ID,PATIENT_ID, SEX,AGEi,RACEi,
                              ...
                              WBCUADM, MEDHISTO_18, WEIGHTADMi, HEIGHTi) %>% ## CONTINUE ADD SEVERETIY VARS
...
#Chronic Kidney Disease #added 10.28.2020

dft1$MEDHISTO_18 <- factor(dft1$MEDHISTO_18, levels = c("0", "1"), 
                  labels = c("No", "Yes"))
