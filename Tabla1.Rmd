...
tabla<-tabla %>% dplyr::select(COVCLINTRIAL, AGEi, age_group, SEX,RACEi, HISETHNI, psource_group, 
...
```{r}
tablafilt <- select(filthosp, -c(CASE_ID, PATIENT_ID, SRC_FAC_ID, TROPADM, - TROPUADM, HGBADM, WBCADM, PLATELET, INITSCR, TROPADM,DDMERU, DDMER, SCRUADM,WBCUADM, PSOURCE_01, PSOURCE_02,PSOURCE_03,PSOURCE_04,PSOURCE_05,PSOURCE_07, PSOURCE_09,
                         DISDATE,DSCHSTAT, ADMDT,DEATHDT,PSOURCE_01,
                               PSOURCE_02,PSOURCE_03,PSOURCE_04,
                               PSOURCE_05, PSOURCE_06, PSOURCE_07,
                               PSOURCE_09, CARDARR, SHKMGMT_01,
