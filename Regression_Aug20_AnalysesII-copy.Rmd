...
filthosp = filthosp %>%
           mutate(admonth = relevel(admonth, "March"))
...
filthosp = filthosp %>% mutate(admonth = relevel(admonth, "March"))
...
nobeforemarch<- filthosp %>% filter(!(admonth == "BeforeMarch")) %>% droplevels()
...
#Regression Model (with continuous month)
```{r}
