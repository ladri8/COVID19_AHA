...
#filthosp = filthosp %>%
#           mutate(PATMANICU = relevel(PATMANICU, "No/ND"))# 2-not managed in ICU
...
contrasts(filthosp$ANTIHYPRGLYM)
...
fit2 <- glmer(COVCLINTRIAL ~ SEX + RACEgroup + age_group + death +
              psource_group + region + BMIgroup + HOSPVENT + PATMANICU +
              fibandflutter + MEDHISTO_03 + MEDHISTO_07 + MEDHISTO_08 + MEDHISTO_09 +
              MEDHISTO_12 + MEDHISTO_13 + MEDHISTO_14 + 
              MEDHISTO_15 + MEDHISTO_16 + MEDHISTO_17 + MEDHISTO_18 + 
              MEDHISTO_28 + MEDHISTO_29 + 
              MEDHISTO_30 + MEDHISTO_31 + MEDHISTO_32 + MEDHISTO_33 + MEDHISTO_34 + 
              MEDHISTO_35 + Cerebrovasc_group+ fibandflutter+ dvt_pe+ smo_vape + DOCUSYMP_12 +
              month_cont + (1|FACILITY_DISPLAY_ID),
             data = filthosp,
             family = binomial,
             nAGQ = 1, 
...
# fit2 <- glmer(COVCLINTRIAL ~ SEX + RACEgroup + age_group + death +
#               psource_group + region + BMIgroup + (1|FACILITY_DISPLAY_ID),
#              data = filthosp,
#              family = binomial,
#              nAGQ = 1, 
#              control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e5)))
...
fit2 <- glmer(COVCLINTRIAL ~ SEX + RACEgroup +
              ...
              MEDHISTO_30 + MEDHISTO_31 + MEDHISTO_32 + MEDHISTO_33 + MEDHISTO_34 + 
              MEDHISTO_35 + (1|FACILITY_DISPLAY_ID ),
             data = filthosp,
             family = binomial,
             nAGQ = 1, 
             control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e5)))
